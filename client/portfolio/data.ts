...
export const aboutData: AboutData = {
  ...
  description: {
    ...
    pl: "Jestem full-stack developerem z ponad 7-letnim doświadczeniem. Tworzę dostępne, szybkie i dopracowane aplikacje webowe w React, TypeScript oraz Node.js. Pracowałem przy serwisach o dużym ruchu, portalach wspierających procesy wewnętrzne oraz aplikacjach w wymagających domenach. Dostarczam funkcje end-to-end: od implementacji i refaktorów po testy, wdrożenia i współpracę ze stakeholderami. W wolnym czasie gram w szachy, lubię gotować i ostatnio wkręciłem się w domowy wyrób wędlin. W Ugandzie współtworzyłem centrum edukacyjne z placem zabaw oraz studnię dla lokalnej społeczności. W Katmandu założyłem klub szachowy, uczyłem programowania i stowrzyłem miejsca pracy dla moich uczniów.",
  },
